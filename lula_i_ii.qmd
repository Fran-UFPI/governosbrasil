...
ggplot(dados_lula1, aes(x= data_final, y= ipca_trimestral)) +
...
names(dados_euro)[2] <- "value"
 ...
 dados_graflula1 <- dados_moedas %>% pivot_longer(cols = c(Dolar,Yuan,Euro), names_to = "Moeda" , values_to = "Taxa")
 ggplot(dados_graflula1,aes(x=Data,y=Taxa,color=Moeda))+
   geom_line(size=1)+
   scale_x_date(date_breaks = "1 year", date_labels ="%Y")+
...
dados_selic_lula1 <- get_series(4189, start_date = "2003-01-01", end_date = "2006-12-31")
names(dados_selic_lula1)[2] <- "Selic"
names(dados_selic_lula1)[1] <- "Anos"
ggplot(dados_selic_lula1, aes(x= Anos, y = Selic))+
...
ggplot(dados_lula2, aes(x= data_final, y= ipca_trimestral)) +
  geom_line( color= "#302681", size= 1.2)+
  scale_x_date(date_breaks = "1 year", date_labels ="%Y")+
  scale_y_continuous(labels = function(x)paste0(x,"%"))+
  labs(
...
names(dados_euro)[2] <- "value"
 ...
 names(dados_moedas) <- c("Data","Dolar","Yuan","Euro")
 dados_graflula2 <- dados_moedas %>% pivot_longer(cols = c(Dolar,Yuan,Euro), names_to = "Moeda" , values_to = "Taxa")
 ggplot(dados_graflula2,aes(x=Data,y=Taxa,color=Moeda))+
   geom_line(size=1)+
   scale_x_date(date_breaks = "1 year", date_labels ="%Y")+
  scale_y_continuous(labels = function(x)paste0(x,"R$"))+
...
dados_selic_lula2 <- get_series(4189, start_date = "2007-01-01", end_date = "2010-12-31")
names(dados_selic_lula2)[2] <- "Selic"
names(dados_selic_lula2)[1] <- "Anos"
ggplot(dados_selic_lula2, aes(x= Anos, y = Selic))+
  geom_line(color= "#ffc222",size=1.2)+
  scale_x_date(date_breaks = "1 year", date_labels ="%Y")+
  scale_y_continuous(labels = function(x)paste0(x,"%"))+
  labs(
